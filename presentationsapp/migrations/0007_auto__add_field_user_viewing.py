...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.viewing'
        db.add_column(u'presentationsapp_user', 'viewing',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['presentationsapp.Presentation'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.viewing'
        db.delete_column(u'presentationsapp_user', 'viewing_id')
    ...
    models = {
        ...
        u'presentationsapp.user': {
            ...
            'viewing': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['presentationsapp.Presentation']", 'null': 'True'})
        }
    }
