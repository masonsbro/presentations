...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.viewing_updated'
        db.add_column(u'presentationsapp_user', 'viewing_updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.viewing_updated'
        db.delete_column(u'presentationsapp_user', 'viewing_updated')
    ...
    models = {
        ...
        u'presentationsapp.user': {
            ...
            'viewing_updated': ('django.db.models.fields.DateTimeField', [], {'null': 'True'})
        }
    }
